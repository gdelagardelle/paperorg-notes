...
enum L10n {
    ...
    enum Settings {
        ...
        static let luxasrCreditTitle = String(localized: "settings.luxasr.credit_title")
        static let luxasrCredit = String(localized: "settings.luxasr.credit")
        static let testingSection = String(localized: "settings.testing.section")
        static let luxasrToggle = String(localized: "settings.testing.luxasr")
        static let luxasrToggleHint = String(localized: "settings.testing.luxasr_hint")
